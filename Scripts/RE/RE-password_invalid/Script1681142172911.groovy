...
Mobile.setText(findTestObject('Object Repository/Register/android.widget.EditText - Username'), 'qr123', 0, FailureHandling.STOP_ON_FAILURE)

Mobile.setText(findTestObject('Object Repository/Register/android.widget.EditText - Email'), 'di@gmail.com', 0, FailureHandling.STOP_ON_FAILURE)

Mobile.sendKeys(findTestObject('Object Repository/Register/android.widget.EditText - Password'), 'qwer')

Mobile.sendKeys(findTestObject('Object Repository/Register/android.widget.EditText - Confirm Password'), 'qwerty')

Mobile.tap(findTestObject('Object Repository/Register/android.widget.Button - MENDAFTAR'), 0, FailureHandling.STOP_ON_FAILURE)

Mobile.verifyElementText(findTestObject('Object Repository/RE-Invalid/android.widget.TextView - This password is invalid'), 'This password is invalid.')
