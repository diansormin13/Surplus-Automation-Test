...
Mobile.setText(findTestObject('Object Repository/Register/android.widget.EditText - Username'), ' ', 0, FailureHandling.STOP_ON_FAILURE)
...
Mobile.sendKeys(findTestObject('Object Repository/Register/android.widget.EditText - Confirm Password'), '123456qwerty')

Mobile.tap(findTestObject('Object Repository/Register/android.widget.Button - MENDAFTAR'), 0, FailureHandling.STOP_ON_FAILURE)

Mobile.verifyElementText(findTestObject('Object Repository/RE-Invalid/android.widget.TextView - Blank Username'), 'The username should not contain any special characters, symbols or spaces.')
