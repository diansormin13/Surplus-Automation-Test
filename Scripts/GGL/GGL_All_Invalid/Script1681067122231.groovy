...
Mobile.setText(findTestObject('Object Repository/Login/android.widget.EditText - Username or email'), ' ', 0, FailureHandling.STOP_ON_FAILURE)

Mobile.sendKeys(findTestObject('Object Repository/Login/android.widget.EditText - Password'), 'qert')

Mobile.tap(findTestObject('Object Repository/Login/android.widget.Button - SIGN IN'), 0, FailureHandling.STOP_ON_FAILURE)

Mobile.verifyElementText(findTestObject('Object Repository/Gagal_Login_All_Invalid/android.widget.TextView - This password is invalid'), 'This password is invalid.')