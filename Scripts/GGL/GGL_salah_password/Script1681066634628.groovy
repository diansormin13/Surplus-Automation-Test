...
Mobile.setText(findTestObject('Object Repository/Login/android.widget.EditText - Username or email'), 'testDian', 0, FailureHandling.STOP_ON_FAILURE)
...
Mobile.verifyElementText(findTestObject('Object Repository/Gagal_Login_Salah_Password/android.widget.TextView - Sandi Anda masukkan tidak sah'), 'Sandi Anda masukkan tidak sah.')